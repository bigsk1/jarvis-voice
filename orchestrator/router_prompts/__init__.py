...
from .v3 import (
    BASE_SYSTEM_PROMPT as V3_SYSTEM_PROMPT,
    BASE_SYSTEM_PROMPT_SHA256 as V3_SYSTEM_PROMPT_SHA256,
)
from .v4 import (
    BASE_SYSTEM_PROMPT as V4_SYSTEM_PROMPT,
    BASE_SYSTEM_PROMPT_SHA256 as V4_SYSTEM_PROMPT_SHA256,
)
...
_ROUTER_PROMPTS = {
    ...
    "v3": (V3_SYSTEM_PROMPT, V3_SYSTEM_PROMPT_SHA256),
    "v4": (V4_SYSTEM_PROMPT, V4_SYSTEM_PROMPT_SHA256),
}

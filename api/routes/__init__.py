...
__all__ = ['alerts_router', 'reminders_router', 'health_router', 'voice_router', 'memory_router', 'query_router', 'conversations_router', 'stash_router', 'canvas_router', 'prices_router', 'price_alerts_router', 'workflows_router', 'intel_router', 'images_router', 'generated_images_router', 'generated_music_router', 'generated_videos_router', 'docs_router', 'scheduled_tasks_router']

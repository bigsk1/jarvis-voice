...
sequenceDiagram
    ...
    alt Server is back
        ...
        API->>TTS: "The Name or details of the Server and is back online, alert canceled"
    else Still down
...
sequenceDiagram
    ...
    User->>J: At point in future "Hey whatever happened to the docker v29 issue in Coolify?"
    J->>User: "Boss just want you to know that you checked it on (date and time) and it was all good"
```
...
# In api/middleware/auth.py ( NOT ADDED YET 11-18-25)
@app.middleware("http")

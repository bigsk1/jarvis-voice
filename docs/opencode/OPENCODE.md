...
- Provider: Ollama
- Model: `gemma4` (default in `local.env.example`; tool-capable on 16GB GPU)
- Alternatives: `qwen3.5:latest`, `qwen3-coder`, `deepseek-r1` (see comments in `config/local.env.example`)

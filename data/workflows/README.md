...
| `movie_night.json` | `/movie_night <mood, constraints, or favorite movies>` (also `/what_to_watch`, `/movie_picker`) | Use required public Trakt metadata plus optional TMDB artwork, YouTube trailers, and Brave streaming context to create a dated Canvas shortlist; no account OAuth or Trakt image hotlinking |

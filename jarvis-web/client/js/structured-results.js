...
class StructuredResultsRenderer {
  ...
  _registerDefaultAdapters() {
    const helpers = {
      getRows: payload => this._rows(payload),
      list: value => this._list(value),
      formatMarketplacePrice: value => this._formatMarketplacePrice(value),
      formatCount: value => this._formatCount(value),
      compactText: (value, maxLength) => this._compactText(value, maxLength),
      displayText: value => this._displayText(value),
      formatDateTime: value => this._formatDateTime(value),
      formatPrice: (value, currency) => this._formatPrice(value, currency),
      formatFlightTime: value => this._formatFlightTime(value),
    };
    const shopping = window.createShoppingResultAdapters(helpers);
    const search = window.createSearchResultAdapters(helpers);
    const localTravel = window.createLocalTravelResultAdapters(helpers);

    this.register('serpapi_amazon_search', shopping.adaptShoppingSearch);
    // Saved conversations may still contain the pre-rename result key.
    this.register('serpapi_search', shopping.adaptShoppingSearch);
    this.register('serpapi_home_depot', shopping.adaptHomeDepotProduct);
    this.register('serpapi_ebay_search', shopping.adaptEbaySearch);
    this.register('serpapi_ebay_product', shopping.adaptEbayProduct);
    this.register('serpapi_hotel_search', localTravel.adaptHotels);
    ...
    this.register('searxng_search', search.adaptSearxngSearch);
    ...
    this.register('serpapi_google_shopping_light', shopping.adaptGoogleShoppingLight);
    this.register('serpapi_google_sports', search.adaptGoogleSports);
    this.register('serpapi_google_trends', search.adaptGoogleTrends);
    this.register('serpapi_google_trending_now', search.adaptGoogleTrendingNow);
    this.register('serpapi_travel_explore', localTravel.adaptTravelExplore);
    this.register('serpapi_google_events', localTravel.adaptGoogleEvents);
    this.register('serpapi_tripadvisor', localTravel.adaptTripadvisor);
    ...
    this.register('flight_search', localTravel.adaptFlights);
    this.register('serpapi_google_local', localTravel.adaptGoogleLocal);
    this.register('serpapi_google_local_services', localTravel.adaptGoogleLocalServices);
    this.register('serpapi_maps_search', localTravel.adaptMaps);

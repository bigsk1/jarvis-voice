...
| `/movie_night <mood, constraints, or favorite movies>` (also `/what_to_watch`, `/movie_picker`) | Build a decisive Trakt-based movie shortlist with related-title signals, optional TMDB artwork, trailers, optional current streaming evidence, and a dated Canvas recommendation | trakt_movies, optional tmdb_movies, optional serpapi_youtube_search, optional brave_llm_context, canvas |

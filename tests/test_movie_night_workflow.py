"""Contracts for the Trakt-backed Movie Night workflow."""
...
def test_movie_night_runs_without_optional_youtube_or_brave_but_requires_trakt():
    workflow = _workflow()
    ...
    missing_trakt = check_workflow_availability(
        workflow,
        available_tools={"get_time", "canvas", "serpapi_youtube_search", "brave_llm_context"},
    )

...
class ToolSearchRuntimeTests(unittest.TestCase):
    ...
    def test_mandatory_ghost_tool_includes_tool_search(self):
        names = _merged_ghost_tool_names("search_memory,remember", {"tool_search", "weather"})
        self.assertEqual(names, ["search_memory", "remember", "tool_search"])
